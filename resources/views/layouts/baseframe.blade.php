...
<head>
    ...
    <link rel="stylesheet" href="{{ public_url('/js/select2/select2.min.css') }}">
...
<body>
    ...
    <script src="{{ public_url('/js/select2/select2.min.js') }}"></script>
    <script src="{{ public_url('/js/select2/i18n/zh-CN.js') }}"></script>
    <script src="{{ public_url('/js/main.min.js') }}"></script>
    <script src="{{ public_url('/js/layer/layer.js') }}"></script>
    <script src="{{ public_url('/js/laydate/laydate.js') }}"></script>
{{--    <script src="{{ public_url('/js/ajax-submit-form.js').'?'.time() }}"></script>--}}
