                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <button type="reset" class="btn btn-warning" onclick="window.location.href='{{ route('admin.gamerecords.betting') }}'">@lang('res.btn.reset')</button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        @foreach ($data as $key => $item)
                            <tr>
                                <td><a href="{{ route('admin.gamerecords.betting_detail', array_merge($queryParams, ['member_id' => $item->id])) }}">{{ $item->name }}</a></td>
