                    ...
                    <div class="card bg-danger">
                        <div class="card-body clearfix">
                            <div class="pull-right">
                                ...
                                <p class="h3 text-white m-b-0">{{ number_format($today_free) }}&nbsp;{{ getCurrentCurrency() }}</p>
                            </div>
                            <div class="pull-left">
                        <span class="img-avatar img-avatar-48 bg-translucent">
                    ...
                    <div class="card bg-success">
                        <div class="card-body clearfix">
                            <div class="pull-right">
                                ...
                                <p class="h3 text-white m-b-0">{{ number_format($today_bet) }}&nbsp;{{ getCurrentCurrency() }}</p>
                            </div>
                            <div class="pull-left"> <span class="img-avatar img-avatar-48 bg-translucent"><i class="mdi mdi-cards-playing-outline fa-1-5x"></i></span> </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card bg-purple">
                        <div class="card-body clearfix">
                            <div class="pull-right">
                                ...
                                <p class="h3 text-white m-b-0">{{ number_format($today_game_profit) }}&nbsp;{{ getCurrentCurrency() }}</p>
                            </div>
                    ...
                    <div class="card bg-danger">
                        <div class="card-body clearfix">
                            <div class="pull-right">
                                ...
                                <p class="h3 text-white m-b-0">{{ number_format($month_free) }}&nbsp;{{ getCurrentCurrency() }}</p>
                            </div>
                            <div class="pull-left">
                        <span class="img-avatar img-avatar-48 bg-translucent">
                            <i class="mdi mdi-currency-cny fa-1-5x"></i>
                    ...
                    <div class="card bg-success">
                        <div class="card-body clearfix">
                            <div class="pull-right">
                                ...
                                <p class="h3 text-white m-b-0">{{ number_format($month_bet) }}&nbsp;{{ getCurrentCurrency() }}</p>
                            </div>
                            <div class="pull-left"> <span class="img-avatar img-avatar-48 bg-translucent"><i class="mdi mdi-cards-playing-outline fa-1-5x"></i></span> </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-purple">
                        <div class="card-body clearfix">
                            <div class="pull-right">
                                ...
                                <p class="h3 text-white m-b-0">{{ number_format($month_game_profit) }}&nbsp;{{ getCurrentCurrency() }}</p>
                            </div>
                            <div class="pull-left"> <span class="img-avatar img-avatar-48 bg-translucent"><i class="mdi mdi-cash-multiple fa-1-5x"></i></span> </div>
                        </div>
                    </div>
...
@section('footer-js')
    <script type="text/javascript" src="{{ public_url('js/Chart.js') }}"></script>
    <script>
